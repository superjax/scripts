...
% Alter data
Pa(125:150,6) = 500*Pa(125:150,6); % Add yaw issue
Pa(150:160,1) = 500*Pa(150:160,1); % Add yaw issue
...
nIters = 20;
% Import data from rosbag
[Xa,Pa] = import_pose_graph('~/.ros/estimator.bag');
